...
struct WebView : UIViewRepresentable {
    ...
    func goHome(){
        webview?.load(URLRequest(url: URL(string: "https://staging.d33sizdmtypegn.amplifyapp.com/login")!))
    }
...
let url = URL(string: "https://staging.d33sizdmtypegn.amplifyapp.com/login")!
